...
try {
  ...
  // SQLite unavailable or errored
}

// In-memory fallback (starts completely empty, no dummy data)
let inMemoryDonors = [];
...
async function getMongoDb() {
  ...
  try {
    ...
    // Ensure admin credentials exist in MongoDB
    ...
    console.error('Failed to connect to MongoDB, falling back:', err.message);
    return null;
  }
}
